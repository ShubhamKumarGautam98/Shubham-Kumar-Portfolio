...
const contentData = {
  default: {
    ...
    desc: "Hover or touch the desk items to explore my tech stack, projects, and experience. Move your cursor to rotate the camera.",
    icon: "🚀"
  },
  laptop: {
    title: "My Tech Stack",
    desc: "Building high-performance web apps with React.js, Next.js, Vite, and Tailwind CSS — plus AI automation workflows using n8n and the OpenAI API.",
    icon: "💻"
  },
  monitor: {
    title: "Current Focus",
    desc: "Specialising in AI-powered automation, n8n workflow design, and OpenAI API integrations. Open to remote full-time and freelance opportunities worldwide.",
    icon: "🖥️"
  },
  coffee: {
    title: "The Fuel",
    desc: "Converting caffeine into clean, maintainable Python and React code. Passionate about automation, problem-solving, and building things that actually save time.",
    icon: "☕"
  },
  trophy: {
    title: "Experience",
    desc: "5+ years of professional experience spanning engineering, enterprise operations, and software development — delivering production-grade automation platforms.",
    icon: "🏆"
  }
};
...
export default function About() {
  ...
  useEffect(() => {
    ...
    const photoTexture = textureLoader.load('/profile.jpg');
