...
export default function PreferencesPopup() {
  ...
  const handleContinue = () => {
    if (selectedDark !== isDark) toggleTheme();
    ...
    <>
      ...
      <Modal>
        <ModalHeader>
          ...
          <Emoji>🎨</Emoji>
          <Title>Welcome! 👋</Title>
          <Subtitle>Choose your preferred theme</Subtitle>
        </ModalHeader>
        ...
        <ModalBody>
          <Section>
            ...
            <ThemeToggleRow>
              <ThemeOption $active={selectedDark} onClick={() => setSelectedDark(true)}>
                <ThemePreview $dark>🌙</ThemePreview>
                <ThemeLabel $active={selectedDark}>Dark</ThemeLabel>
              </ThemeOption>
              <ThemeOption $active={!selectedDark} onClick={() => setSelectedDark(false)}>
                <ThemePreview>☀️</ThemePreview>
                <ThemeLabel $active={!selectedDark}>Light</ThemeLabel>
              </ThemeOption>
            </ThemeToggleRow>
          </Section>
